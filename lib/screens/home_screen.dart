          ...
          children: [
            Container(
              ...
              child: TextField(
                ...
                onSubmitted: (value)=> Get.to(()=>SearchScreen(value, "Search")),
              ...
              builder: (controller)=> Column(
                children: [
                    ...
                    itemBuilder: (context, index, pageview) {
                      try {
                        if (controller.featuredlist.isEmpty) {
                          ...
                          return FeaturedItem(controller.featuredlist[index]);
                        }
                      } catch (e) {
                        print("Error loading image: $e");
                        return Placeholder(); // Placeholder or some other widget for error handling
                      }
                    },
                  ),
                  ...
                  StaggeredGrid.count(
                    crossAxisCount: 2,
                    children :
                    controller.recommendedlist.
                    map((product)=>RecommendedItem(product)).toList(),
                  ),
                ],
            ),
            ),
